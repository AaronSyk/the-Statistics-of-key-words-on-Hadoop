...
public class inHive {
    ...
    private static String url = "jdbc:hive2://172.16.42.10:10013/hive";
    ...
    public static void run(Map<String, String> path) {
        try {
            ...
            String sql = "load data inpath '/file/weibo/output/part-r-00000' into table hot_word partition(timeday='20160221')" ;
